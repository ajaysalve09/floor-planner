...
// Open Feedback form
feedbackBtn.addEventListener("click", ()=> showPage("feedback"));

// Close Feedback form
closeFeedbackTop.addEventListener("click", ()=> showPage("home"));

// Submit Feedback → Thank You
submitFeedbackBtn.addEventListener("click", ()=>{
  showPage("feedbackThankYou");
});

// Close Thank You → Home
closeFeedbackBtn.addEventListener("click", ()=> showPage("home"));

// Handle browser back/forward buttons
window.addEventListener("popstate", (event) => {
  if(event.state && event.state.page){
    showPage(event.state.page, false); // false = do not push again
  } else {
